  ...
  return <>
    ...
    <main className="product-page templates-page">
      ...
      {view === "browse" ? <>
        ...
        <button type="button" disabled={saving} onClick={() => { setEditing(null); setDraft(emptyDraft); setSaved(null); setSaveError(""); pendingSave.current = null; }}>Start a new template</button>
