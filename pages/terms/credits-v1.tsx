...
export default function CreditTermsPage() {
  return <PolicyPage title="Credit purchase terms" path={CREDIT_TERMS_PATH}
    ...
    <section id="receipts-and-refunds"><h2>Receipts and refunds</h2>
      <p>Open <Link href="/account">Your account → Purchases and receipts</Link> to see payment status, receipts, and credit adjustments. Returning from checkout alone does not confirm payment.</p>
