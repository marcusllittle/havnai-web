    ...
    <main className="product-page policy-page support-page">
      ...
      <section className="support-topics" aria-label="Support topics">
        <article id="payment-help"><CreditCard size={25} aria-hidden="true" /><h2>Payments &amp; refunds</h2>
          ...
          <div className="support-topic-links"><Link href="/pricing">Credit packs<ArrowUpRight size={15} aria-hidden="true" /></Link><Link href={CREDIT_REFUND_PATH}>Refund policy<ArrowUpRight size={15} aria-hidden="true" /></Link></div>
        </article>
        <article id="account-help"><KeyRound size={25} aria-hidden="true" /><h2>Account access</h2>
          ...
          <Link href="/pricing">Review credits<ArrowUpRight size={15} aria-hidden="true" /></Link>
        </article>
        <article id="creation-help"><Sparkles size={25} aria-hidden="true" /><h2>Creations &amp; your library</h2>
          ...
          <p>Include enough detail for support to identify the creation. If the result appears in Collection, include the visible title, model, and approximate creation time.</p>
          <div className="support-topic-links"><Link href="/library">Open Collection<ArrowUpRight size={15} aria-hidden="true" /></Link><Link href="/create">Create page<ArrowUpRight size={15} aria-hidden="true" /></Link></div>
        </article>
        <article id="node-wallet-help"><Server size={25} aria-hidden="true" /><h2>Wallets &amp; nodes</h2>
          ...
          <div className="support-topic-links"><Link href="/wallet">Wallet page<ArrowUpRight size={15} aria-hidden="true" /></Link><Link href="/run-a-node">Node setup guide<ArrowUpRight size={15} aria-hidden="true" /></Link></div>
        </article>
      </section>
